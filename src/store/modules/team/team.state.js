  ...
  bios: [
    {
      ...
      <p>An avid runner, outdoor enthusiast, and world traveler, Tom cherishes family above all else. When he's not working, running, biking, hiking, skiing, traveling, or hanging with the family, Tom dreams about designing and building his own piece of paradise in the Blue Ridge Mountains.</p>
      <p>A recipient of numerous awards, Tom is a distinguished member of the American Institute of Architecture (AIA) and licensed in Virginia.</p>
      `,
    },
    {
      id: 'vice-president',
      ...
      <p>Outside of the office, Jeremy enjoys mountain biking, cooking, baking, designing and making furniture and time with his wife.</p>
      <p>Jeremy is a distinguished member of the American Institute of Architecture (AIA) and licensed in Virginia, Maryland and Washington, D.C.</p>
      `,
    },
    {
      id: 'architect',
      ...
      <p>Chris still enjoys woodworking and has built nearly all his home furnishings. He volunteers with Makersmiths as a shop steward, teaching woodworking and maintaining the wood shop in Leesburg. Away from the sawdust and tools, Chris can be found cycling the gravel of Loudoun County and traveling to mountain bike trails throughout the region. Chris holds a degree in Architecture from Virginia Tech.</p>
      `,
    },
    {
      id: 'studio-manager',
